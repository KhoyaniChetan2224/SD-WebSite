...
<head>
  ...
  <title> <b> SD Hotels - Contact </b> </title>  
    ...
    <div class="col-lg-6 col-md-6 mb-5 px-4">
      ...
      <iframe class="w-100 rounded mb-4" height="320" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d461323.1437394909!2d81.47190865767885!3d25.401896221973697!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x398534c9b20bd49f%3A0xa2237856ad4041a!2sPrayagraj%2C%20Uttar%20Pradesh!5e0!3m2!1sen!2sin!4v1714039942216!5m2!1sen!2sin" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        ...
        <h5 class="mt-4"> Call us </h5>
          ...
          <a href="mailto: khoyani'ssd@gmail.com" class="d-inline-block mb-2 text-decoration-none text-dark"> 
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
              <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414zM0 4.697v7.104l5.803-3.558zM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586zm3.436-.586L16 11.801V4.697z"/>
            </svg>  khoyani'ssd@gmail.com 
          </a>
    ...
    <div class="col-lg-6 col-md-6 px-4">
      <div class="bg-white rounded shadow p-4">
        <form>
          ...
          <input type="text" class="form-control shaow-none">
          </div>
          <div class="mt-3">
            <lable class="form-lable" style="font-weight: 500;"> Email </lable>
          <input type="email" class="form-control shaow-none">
          </div>
          <div class="mt-3">
          ...
          <div class="mt-3">
            <lable class="form-lable" style="font-weight: 500;"> Message </lable>
          <textarea class="form-control shadow-none" rows="5" style="resize: none;"></textarea>
          </div> 
            <button type="submit" class="btn text-white custom-bg mt-2"> SEND </button>
        </form>
      </div>
    </div>
  </div>
